...
export default function Hero() {
  return (
    <div className="h-screen w-full bg-astral-50 px-4 overflow-hidden">
      <div className="max-w-screen-2xl mx-auto h-full grid grid-cols-5">
        <div className="flex flex-col justify-center h-full col-span-3">
          ...
          <button className="flex items-center gap-4 group hover:gap-6 transition-all duration-300">
            <span className="text-xl rounded-full p-7 bg-jaffa-400 text-white">
